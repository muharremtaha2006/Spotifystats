...
def settings_menu(root):
    ...
    def update_settings():
        ...
        settings.update({"background_type": bg_type, "background_value": bg_value})
    ...
    reset_button = ctk.CTkButton(settings_frame, text="Varsayılana Sıfırla", command=lambda: apply_background(root, DEFAULT_SETTINGS))
